...
const highlights = [
  { icon: "✦", text: "Armações exclusivas" },
  { icon: "✦", text: "Óculos de sol premium" },
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4 mb-14">
            <a
              ...
              className="flex items-center gap-2.5 bg-gold hover:bg-gold-light text-primary-foreground font-semibold px-7 py-3.5 rounded-full transition-all duration-200 shadow-[var(--shadow-gold)] text-base"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 border border-gold/50 hover:border-gold text-gold hover:bg-gold/10 font-semibold px-7 py-3.5 rounded-full transition-all duration-200 text-base"
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" aria-hidden>
