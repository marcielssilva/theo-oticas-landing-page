    ...
    <section className="py-24 bg-navy-light relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{ background: "radial-gradient(ellipse, hsl(43,74%,55%) 0%, transparent 70%)" }}
        />
      </div>
      ...
      <div className="relative container mx-auto px-4 md:px-8 text-center max-w-2xl">
        ...
        <h2 className="font-display text-3xl md:text-5xl font-bold text-foreground mt-3 mb-6">
          Visite a Theo Óticas hoje mesmo
        </h2>
        <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
          Estamos te esperando no Mercadão Municipal de Itapetininga.<br />
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-gold hover:bg-gold-light text-primary-foreground font-bold px-10 py-4 rounded-full transition-all duration-200 shadow-[var(--shadow-gold)] text-lg"
        >
